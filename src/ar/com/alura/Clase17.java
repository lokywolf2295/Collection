...
public class Clase17 {
    ...
    public static void main(String[] args) {
        ...
        //si luego recorrer la totalidad de elementos de la lista, y pedimos otro next obtendremos un error
        alumnoIterator.next(); //arroja java.util.NoSuchElementException
    }
}
