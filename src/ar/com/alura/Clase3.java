...
public class Clase3 {
    ...
    public static void main(String[] args) {
        ...
        //Ordenamiento utilizando el metodo Sort de Collections
        Collections.sort(cursos);
        System.out.println(cursos);
        
        //Ordenamiento reverso utilizando el metodo Sort de Collections
        Collections.sort(cursos, Collections.reverseOrder());
        System.out.println(cursos);
        
        //Ordenamiento utilizando el metodo Sort que recibe el comparator de naturalOrder
